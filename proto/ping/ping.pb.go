...
func (x *PingResponse) GetHash() string {
	if x != nil {
		return x.Hash
	}
	return ""
...
const file_proto_ping_ping_proto_rawDesc = "" +
	"\n" +
	"\x15proto/ping/ping.proto\x12\x04ping\")\n" +
	"\vPingRequest\x12\f\n" +
	...
	"\vPingService\x12-\n" +
	"\x04Ping\x12\x11.ping.PingRequest\x1a\x12.ping.PingResponseB2Z0github.com/khzs/connectivity-listener/proto/pingb\x06proto3"

var (
	file_proto_ping_ping_proto_rawDescOnce sync.Once
	file_proto_ping_ping_proto_rawDescData []byte
)

func file_proto_ping_ping_proto_rawDescGZIP() []byte {
	file_proto_ping_ping_proto_rawDescOnce.Do(func() {
		file_proto_ping_ping_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_ping_ping_proto_rawDesc), len(file_proto_ping_ping_proto_rawDesc)))
	})
	return file_proto_ping_ping_proto_rawDescData
}

var file_proto_ping_ping_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proto_ping_ping_proto_goTypes = []any{
...
func file_proto_ping_ping_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_ping_ping_proto_rawDesc), len(file_proto_ping_ping_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
